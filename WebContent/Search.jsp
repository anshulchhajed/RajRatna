...
<div class="container-fluid text-center">    
  <jsp:include page="left.jsp"></jsp:include>
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <h1>
Search Stock <br><br><input type="text" name="t1" autocomplete="off" placeholder=" Itemcode / ItemName / Color" autofocus onkeyup="sendInfo()" style="font-size:20px;height:40px; width:100%;"> </input>
      </h1>
      <hr>
